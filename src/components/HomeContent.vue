                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-4 mb-4 box-shadow keyboardCard" v-for="item in filterProducts" :key="item.id">
                        <div class="card border-0 shadow-sm">
                                <div style="height: 180px;background-size: contain; background-position: center; background-repeat: no-repeat; position: relative;" :style="{ backgroundImage:`url(${item.imageUrl})`}">
                                </div>
